...
class Systems(SpaceTraderConnection,DictCacheManager):
    ...
    def cache_system(func: Callable) -> Callable:
        ...
        This version reads the cached systems data and tries to find information about the
        given system. If the file exists, but there is no data on the given system, this
